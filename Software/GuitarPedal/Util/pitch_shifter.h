...
class PitchShifter
{
  public:
    ...
    float Process(float in)
    {
        ...
        bool recalc_a_fun =
            ((transpose_ >= 0.f) && (prev_phs_a_ > fade1)) || ((transpose_ < 0.f) && prev_phs_a_ < fade1);
        bool recalc_b_fun =
            ((transpose_ >= 0.f) && (prev_phs_b_ > fade2)) || ((transpose_ < 0.f) && prev_phs_b_ < fade2);
